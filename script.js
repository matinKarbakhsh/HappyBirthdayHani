...
(() => {
  ...
  // Tries assets/images/secret-photo.<ext> for each common extension in turn.
  // Whichever one actually exists gets displayed; if none exist, the
  // friendly placeholder card is shown instead — the modal is never blank.
  function loadSecretImage() {
    const img = $("#secret-image");
    const fallback = $("#secret-image-fallback");
    ...
    function tryNext() {
      ...
      const candidate = `assets/images/secret-photo.${extensions[i]}`;
      i++;
